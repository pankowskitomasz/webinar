            ...
            <Container fluid className={"contact-form align-items-center p-0 py-5 d-flex minh-50vh " + this.props.classExt}>
                <Row className="mx-auto text-center w-100">
                    <Col xs={10} md={6} className="mx-auto p-0 d-flex align-items-center">
                        <Card className="mx-auto bg-black opacity-9 border-primary shadow">
                            <Card.Header className="text-primary text-start border-primary">
                                Message sent!
                            </Card.Header>
                            <Card.Body className="text-center text-primary p-5">
                                <p className="lead">Message was sent!</p>
                                <Button variant={"outline-primary rounded-pill"} onClick={this.hndBack.bind(this)}>
                                    back to Form
                                </Button>
                            </Card.Body>
                        </Card>
